...
def plot_Weibull_cdf(t_horizon, shape, scale, data_name='sim', num_inst=1000, num_feat=200, seed=42):
    ...
    if not os.path.exists('Figures'):
        os.makedirs('Figures')
    if data_name == 'sim':
        plt.savefig(r'.\Figures\Weibull_cdf_#clusters{}_{}_{}x{}_seed{}.png'.
                    format(len(shape), data_name, num_inst, num_feat, seed))
    else:
        plt.savefig(r'.\Figures\Weibull_cdf_#clusters{}_{}_seed{}.png'.
...
def plot_KM(y_list, cluster_method, data_name,
    ...
    if not os.path.exists('Figures'):
        os.makedirs('Figures')
    if data_name == 'sim':
        plt.savefig(r'.\Figures\{}_{}_KM_plot_#clusters{}_{}_{}x{}_seed{}.png'.
                    format(cluster_method, stage, len(y_list), data_name, num_inst, num_feat, seed))
    else:
        plt.savefig(r'.\Figures\{}_{}_KM_plot_#clusters{}_{}_seed{}.png'.
